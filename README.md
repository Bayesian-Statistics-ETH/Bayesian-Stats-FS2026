...
The material covered in the course is listed in the syllabus and is influenced by previous generations of this course. 
...
- `help`: helpers and cheat sheets.
- `syllabus.md`: A reasonably complete list of what was covered in the lectures.

These will be populated as the course progresses through the term.

## Acknowledgements
- *Tilman Troester and Veronika Oehl*,  ETH Zurich
- 
